package com.bilgeadam.MovieAppJava5.utility;
...
import com.bilgeadam.MovieAppJava5.service.GenreService;
import com.bilgeadam.MovieAppJava5.service.MovieService;
import com.bilgeadam.MovieAppJava5.service.UserService;
import com.bilgeadam.MovieAppJava5.utility.data.Sample;
...
public class DataImpl  implements ApplicationRunner {
    ...
    public void createUser(){
        ...
        user1.setComments(List.of(
                ...
                MovieComment.builder().content("cok iyi").user(user1).movie(movieService.findbyId(1L)).build(),
                MovieComment.builder().content("idare eder").user(user1).movie(movieService.findbyId(136L)).build(),
                MovieComment.builder().content("iyi").user(user1).movie(movieService.findbyId(85)).build()
        ));
        ...
        user2.setComments((List.of(
                MovieComment.builder().content("iyi").user(user2).movie(movieService.findbyId(2L)).build(),
                MovieComment.builder().content("iyi").user(user2).movie(movieService.findbyId(136L)).build(),
                MovieComment.builder().content("cok iyi").user(user2).movie(movieService.findbyId(106L)).build(),
                MovieComment.builder().content("idare eder").user(user2).movie(movieService.findbyId(26L)).build(),
                MovieComment.builder().content("iyi").user(user2).movie(movieService.findbyId(25)).build()
        )));
        ...
        user3.setComments(List.of(
                ...
                MovieComment.builder().content("cok iyi").user(user3).movie(movieService.findbyId(106L)).build(),
                MovieComment.builder().content("berbat").user(user3).movie(movieService.findbyId(10L)).build(),
                MovieComment.builder().content("iyi").user(user3).movie(movieService.findbyId(15)).build()
        ));
        ...
        User user4 = User.builder()
                ...
                .surName("Sönmez").password("123").phone("123")
                .favGenres(genreService.createGenresWithNames(List.of("Anime", "Action", "Mystery", "Supernatural"))).build();

        user4.setComments(List.of(
                MovieComment.builder().content("cok iyi").user(user4).movie(movieService.findbyId(51L)).build(),
                MovieComment.builder().content("þahane").user(user4).movie(movieService.findbyId(105L)).build(),
                MovieComment.builder().content("idare eder").user(user4).movie(movieService.findbyId(1L)).build()
        ));

        User user5 = User.builder().email("admin@gmail.com").name("Mustafa").
                surName("Öztürk").userType(UserType.ADMIN).password("admin").phone("123")
        ...
        user5.setComments(List.of(
                MovieComment.builder().content("cok iyi").user(user5).movie(movieService.findbyId(14L)).build(),
                MovieComment.builder().content("iyi").user(user5).movie(movieService.findbyId(66L)).build(),
                MovieComment.builder().content("berbat").user(user5).movie(movieService.findbyId(10L)).build(),
                MovieComment.builder().content("berbat").user(user5).movie(movieService.findbyId(108L)).build(),
                MovieComment.builder().content("iyi").user(user5).movie(movieService.findbyId(25)).build()
        ));
